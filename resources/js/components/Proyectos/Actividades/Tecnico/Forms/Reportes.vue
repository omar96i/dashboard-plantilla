    ...
    <div v-if="!message">
        <form method="post">
            ...
            <div class="text-center">
                <button type="button" class="btn btn-success" @click="store()">Agregar Reporte</button>
            </div>
        </form>
    </div>
    <div v-else class="mt-4">
        <b-alert show variant="success">Actualmente la actividad se encuentra completada, No se puede enviar reportes</b-alert>
    </div>
