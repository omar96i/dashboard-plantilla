                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <b-tabs content-class="mt-3">
                            <b-tab title="Reagendamiento" active>
                                <form method="post">
                            ...
                            <b-tab title="Solicitud de Productos">
                                <solicitud-productos :actividad_id="actividad_id"></solicitud-productos>
                            </b-tab>
                        </b-tabs>
...
<script>
    ...
    import SolicitudProductos from './Tecnico/Forms/SolicitudProductos'
    export default {
        components: {
			SpinnerView,
            SolicitudProductos
